...
def register_routes(app):
    ...
    def create2(decoded_token):
        ...
        if form.validate():
            ...
            for field, field_errors in form.errors.items():
                # Apenas exibe a primeira mensagem de erro por campo
    ...
    @token_required
    def get_one2(decoded_token, user_id):
    ...
    @token_required
    def update2(decoded_token, user_id):
        data = request.get_json()
    ...
    @token_required
    def delete2(decoded_token, user_id):
